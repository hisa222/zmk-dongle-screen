...
// #if CONFIG_DONGLE_SCREEN_MAIN_BUTTONS_ROW1 && !CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE && !CONFIG_DONGLE_SCREEN_BONGO_BOO_ACTIVE && !CONFIG_DONGLE_SCREEN_BONGO_SPHEAL_ACTIVE && !CONFIG_DONGLE_SCREEN_BONGO_DOE_ACTIVE
