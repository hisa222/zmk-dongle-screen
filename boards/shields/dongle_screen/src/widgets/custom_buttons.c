...
static struct action_btn_bundle custom_button_1_bundle;
static struct action_btn_bundle custom_button_2_bundle;
static struct action_btn_bundle custom_button_3_bundle;
static struct action_btn_bundle custom_button_4_bundle;
static struct action_btn_bundle custom_button_5_bundle;
...
custom_button_2_bundle.visual_btn = make_visual_btn(parent, "PASTE",
    ...
    #elif CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE
        lv_color_hex(0x000000), lv_color_hex(0xDCE24A), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, 0, -30);
    #elif !CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE && CONFIG_DONGLE_SCREEN_BONGO_BOO_ACTIVE
        #if CONFIG_DONGLE_SCREEN_BUTTONS_TEXT_COLORFUL
    ...
    #elif !CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE && !CONFIG_DONGLE_SCREEN_BONGO_BOO_ACTIVE && CONFIG_DONGLE_SCREEN_BONGO_SPHEAL_ACTIVE
        #if CONFIG_DONGLE_SCREEN_BUTTONS_TEXT_COLORFUL
            lv_color_hex(0xFEEECE), lv_color_hex(0xFF7C80), lv_color_hex(0x7BDEFD), LV_ALIGN_CENTER, 0, -30);
        #else
    ...
    #else
        lv_color_hex(0xDCE24A), lv_color_hex(0xFFFFFF), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, 0, -30);
    #endif
...
custom_button_3_bundle.visual_btn = make_visual_btn(parent, "CUT",
        ...
        lv_color_hex(0x000000), lv_color_hex(0xFFFFFF), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, 90, -30);
    #elif CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE
        lv_color_hex(0x000000), lv_color_hex(0xE2904A), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, 90, -30);
    #elif !CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE && CONFIG_DONGLE_SCREEN_BONGO_BOO_ACTIVE
        #if CONFIG_DONGLE_SCREEN_BUTTONS_TEXT_COLORFUL
            lv_color_hex(0x000000), lv_color_hex(0xFFFFFF), lv_color_hex(0xFFFFFF), LV_ALIGN_CENTER, 90, -30);
        #else
        ...
        #endif
    #elif TEXT_COLORFUL
            lv_color_hex(0x000000), lv_color_hex(0xE2904A), lv_color_hex(0xE2904A), LV_ALIGN_CENTER, 90, -30);
    #else
        lv_color_hex(0xE2904A), lv_color_hex(0xFFFFFF), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, 90, -30);
    #endif
...
custom_button_4_bundle.visual_btn = make_visual_btn(parent, "UNDO",
    ...
    #elif CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE
        lv_color_hex(0x000000), lv_color_hex(0xE2504A), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, -90, 50);
    #elif !CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE && CONFIG_DONGLE_SCREEN_BONGO_BOO_ACTIVE
        #if CONFIG_DONGLE_SCREEN_BUTTONS_TEXT_COLORFUL
        ...
        #endif
    #elif TEXT_COLORFUL
            lv_color_hex(0x000000), lv_color_hex(0xE2504A), lv_color_hex(0xE2504A), LV_ALIGN_CENTER, -90, 50);
    #else
        lv_color_hex(0xE2504A), lv_color_hex(0xFFFFFF), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, -90, 50);
    #endif
...
custom_button_5_bundle.visual_btn = make_visual_btn(parent, "PRTSC",
    ...
    #elif CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE
        lv_color_hex(0x000000), lv_color_hex(0xE24AE2), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, 0, 50);
    #elif !CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE && CONFIG_DONGLE_SCREEN_BONGO_BOO_ACTIVE
        #if CONFIG_DONGLE_SCREEN_BUTTONS_TEXT_COLORFUL
        ...
        #endif
    #elif TEXT_COLORFUL
            lv_color_hex(0x000000), lv_color_hex(0xE24AE2), lv_color_hex(0xE24AE2), LV_ALIGN_CENTER, 0, 50);
    #else
        lv_color_hex(0xE24AE2), lv_color_hex(0xFFFFFF), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, 0, 50);
    #endif
...
custom_button_6_bundle.visual_btn = make_visual_btn(parent, "REDO",
        ...
        lv_color_hex(0x000000), lv_color_hex(0xFFFFFF), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, 90, 50);
    #elif CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE
        lv_color_hex(0x000000), lv_color_hex(0x4AE290), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, 90, 50);
    #elif !CONFIG_DONGLE_SCREEN_BONGO_CAT_ACTIVE && CONFIG_DONGLE_SCREEN_BONGO_BOO_ACTIVE
        #if CONFIG_DONGLE_SCREEN_BUTTONS_TEXT_COLORFUL
            lv_color_hex(0x000000), lv_color_hex(0xFFFFFF), lv_color_hex(0xFFFFFF), LV_ALIGN_CENTER, 90, 50);
        #else
    ...
    #else
        lv_color_hex(0x4AE290), lv_color_hex(0xFFFFFF), lv_color_hex(BORDER_COLOR_NORMAL), LV_ALIGN_CENTER, 90, 50);
    #endif
